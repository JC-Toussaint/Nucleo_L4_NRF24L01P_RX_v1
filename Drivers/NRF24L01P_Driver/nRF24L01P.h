...
#define NRF24L01_CE_HIGH         HAL_GPIO_WritePin(GPIOA, NRF_CE_Pin, GPIO_PIN_SET)
#define NRF24L01_CSN_LOW         HAL_GPIO_WritePin(GPIOA, NRF_NSS_Pin, GPIO_PIN_RESET)
#define NRF24L01_CSN_HIGH        HAL_GPIO_WritePin(GPIOA, NRF_NSS_Pin, GPIO_PIN_SET)
